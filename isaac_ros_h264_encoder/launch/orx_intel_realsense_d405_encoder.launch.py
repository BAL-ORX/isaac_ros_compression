...
def launch_setup(context, *args, **kwargs):
    ...
    with open(config_file.perform(context), "r") as file:
        ...
        color_profile = config_file["depth_module"]["color_profile"]
    ...
    intel_realsense_rgb_raw_topic = PathJoinSubstitution([camera_name, "color", "image_rect_raw"])
    intel_realsense_rgb_compressed_topic = PathJoinSubstitution([camera_name, "color", "image_rect_raw", "h264"])
    ...
    return launch.LaunchDescription(
        [
            ...
            DeclareLaunchArgument(
                "config_file",
                default_value="/intel_realsense_d405_ros_config.yaml",
