...
def launch_setup(context, *args, **kwargs):
    ...
    intel_realsense_rgb_encoded_topic = PathJoinSubstitution([camera_name, "color", "image_rect_raw", "h264"])
    intel_realsense_rgb_decompressed_topic = PathJoinSubstitution(
        [camera_name, "color", "image_rect_raw", "decompressed"]
    )
