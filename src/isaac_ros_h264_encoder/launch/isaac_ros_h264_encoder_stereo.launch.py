...
def generate_launch_description():
    ...
    config_path = os.path.join(pkg_share, 'config', 'zed.yaml')
    ...
    left_in = cfg['left_image_topic']
    right_in = cfg['right_image_topic']
    left_out = cfg['left_compressed_topic']
    right_out = cfg['right_compressed_topic']
